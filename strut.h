...
#ifndef SOMEWM_STRUT_H
#define SOMEWM_STRUT_H

#include <lua.h>
#include <stdint.h>
#include <stdbool.h>

/* Strut - reserved screen space (e.g., for panels/docks)
 * This matches AwesomeWM's strut_t structure exactly.
 *
 * The 12 uint16_t fields define reserved areas on screen edges:
 * - left, right, top, bottom: width of reserved area in pixels
 * - *_start_*, *_end_*: coordinates where reservation begins/ends
 */
typedef struct
{
