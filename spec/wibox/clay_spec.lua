...
describe("wibox.clay", function()
    ...
    it("maps margins onto padding, the child growing into them", function()
        ...
        -- The drawable's widget takes the whole drawin; the margin's child
        -- takes the whole padded box, with its own size as the floor a
        -- parent that wraps its content counts.
